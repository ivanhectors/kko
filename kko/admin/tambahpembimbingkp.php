...
<head>
	...
	<title>Admin | Tambah Dosen Pembimbing Mahasiswa Kerja Paktik</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Tambah Pembimbing Kerja Praktik Mahasiswa</h3>
							</div>
...
<label class="control-label" for="basicinput">Dosen Pembimbing</label>
<div class="controls">
...
<?php } ?>
	...
	<div class="module">
							<div class="module-head">
								<h3>Data Mahasiswa Bimbingan Dosen - Kerja Praktik</h3>
							</div>

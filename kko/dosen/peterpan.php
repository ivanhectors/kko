...
<?php $query=mysqli_query($con,"select * from kelompok k join users u on k.idusers=u.nim join dosen d on k.iddosen=d.username where k.iddosen='".$_SESSION['dlogin']."' order by k.updationDateKelompok DESC");
$cnt=1;
...
?></td>
      ...
      ?>     </td>
											<td><center>
											<a href="javascript:void(0);" onClick="popUpWindow('http://localhost//peterpan/kko/dosen/edit_record.php?id=<?php echo htmlentities($row['idkelompok']);?>');" title="Edit Data : <?php echo htmlentities($row['namalengkap']);?> ?">

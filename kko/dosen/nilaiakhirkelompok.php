  ...
  <li>Kelompok Peterpan</li>
	...
	<div class="module">
							<div class="module-head">
								<h3>Data Kelompok Mahasiswa Peterpan</h3>
							</div>
...
$year = date('Y');
 ...
 $query=mysqli_query($con,"SELECT DISTINCT klppeterpan FROM peterpan.kelompok WHERE kelompok.iddosen='".$_SESSION['dlogin']."' and kelompok.semester='$semester'");
$cnt=1;
...
?>									
										<tr>
											...
											<td>
											<a href="inputnilaipeterpan.php?klppeterpan=<?php echo $row['klppeterpan']?>" ><i class="icon-edit"></i></a>
										</tr>
										<?php $cnt=$cnt+1; } ?>

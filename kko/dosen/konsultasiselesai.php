...
<?php 
$st='selesai';
$query=mysqli_query($con,"select tblkonsultasi.*,users.namalengkap as name,matakuliah.kdmatakuliah,matakuliah.matakuliah as makul from tblkonsultasi join matakuliah on tblkonsultasi.idmatakuliah=matakuliah.kdmatakuliah join users on users.nim=tblkonsultasi.idusers where tblkonsultasi.sts_konsul='$st' and iddosen='".$_SESSION['dlogin']."' order by tblkonsultasi.regDate desc");

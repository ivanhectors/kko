...
popUpWin = open(URLStr,'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width='+500+',height='+670+',left='+left+', top='+top+',screenX='+left+',screenY='+top+'');
}
...
<?php } ?>
	...
	<div class="module">
							<div class="module-head">
								<h3>Daftar Mahasiswa Bimbingan Kerja Praktik </h3>
							</div>
...
<?php 
$query=mysqli_query($con,"select * from krs k join users u on k.idusers=u.nim join matakuliah m on k.idmatakuliah=m.kdmatakuliah where m.tags='kp' and k.iddosen='".$_SESSION['dlogin']."'");
$cnt=1;
...
?>									
										<tr style="font-size:11px;">
											...
											<td><?php echo htmlentities($row['tempatkp']);?></td>

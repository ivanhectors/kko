...
{
$sql=mysqli_query($con,"SELECT password FROM dosen where password='".md5($_POST['password'])."' && username='".$_SESSION['dlogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update dosen set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['dlogin']."'");
...
<div class="controls">
<input type="password" placeholder="Enter your new Password again"  onpaste="return false;" name="confirmpassword" class="span8 tip" required>
</div>
</div>

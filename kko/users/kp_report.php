...
?>
  ...
  $year = date('Y');
	...
	if($bulan_ini<=6){
      ...
      $nim=$_SESSION['login'];
$query=mysqli_query($con,"select * from tblkonsultasi t join users u on t.idusers=u.nim join dosen d on t.iddosen=d.username where t.idmatakuliah='SI4313' and t.idusers='".$_SESSION['login']."' and t.semester='".$_GET['semester']."' and t.sts_konsul='selesai' order by t.regDate ASC");
$cnt=1;

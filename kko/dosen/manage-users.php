...
<td><center><a href="javascript:void(0);" onClick="popUpWindow('http://localhost//peterpan/kko/dosen/userprofile.php?uid=<?php echo htmlentities($row['idusers']);?>');" title="View Details : <?php echo htmlentities($row['namalengkap']);?> ?">

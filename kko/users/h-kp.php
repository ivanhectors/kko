...
<?php include("includes/sidebar.php");?>
  ...
  $cnt=1;
  $query=mysqli_query($con,"select * from tblkonsultasi t join matakuliah m on t.idmatakuliah=m.kdmatakuliah join dosen d on t.iddosen=d.username where idusers='".$_SESSION['login']."' and m.tags='kp' and t.semester='$semester' order by t.lastUpdationDate DESC");

...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,dosen,complaintType,state,noc,complaintDetails,complaintFile) values('$uid','$category','$subcat','$complaintype','$state','$noc','$complaintdetials','$compfile')");

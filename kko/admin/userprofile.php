...
?>
  ...
  echo "Block";
    ...
    <tr>
      ...
      <td > 
      <button type="submit" id="submit4" class="btn btn-warning btn-xs"name="submit4" value="Reset Password"  onClick="return confirm('Yakin ingin mereset password mahasiswa ini ?')" style="cursor: pointer;"  ><i class="fa fa-unlock-alt"></i> Reset Password</button>

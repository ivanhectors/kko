...
$ret1=mysqli_query($con,"select * from krs k join users u on k.idusers=u.nim join dosen d on k.iddosen=d.username join matakuliah m on k.idmatakuliah=m.kdmatakuliah where m.tags='kp'and k.idusers='".$_GET['uid']."' and k.pembimbing='1'");
while($row=mysqli_fetch_array($ret1))
{
?>
    <tr height="50">
...
$ret1=mysqli_query($con,"select distinct semester from krs k join matakuliah m on k.idmatakuliah=m.kdmatakuliah where m.tags='kp'and k.idusers='".$_GET['uid']."' and k.pembimbing='2'");
while($row=mysqli_fetch_array($ret1))
{
?>
    <tr height="50">

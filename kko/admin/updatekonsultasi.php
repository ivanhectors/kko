...
$sql=mysqli_query($con,"update tblkonsultasi set status='$status' where nokonsultasi='$complaintnumber'");

echo "<script>alert('Catatan Konsultasi telah dikirimkan!');</script>";

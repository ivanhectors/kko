...
if(isset($_POST['submit']))
{
    ...
    $telpadmin=$_POST['phoneadmin'];


$sql=mysqli_query($con,"update admin set username='$username',nmadmin='$nmadmin',emailadmin='$emailadmin',phoneadmin='$telpadmin' where username='".$_SESSION['alogin']."'");
$_SESSION['msg']="Profil Admin berhasil di Ubah.";
...
$ret=mysqli_query($con,"select * from admin where username='".$_SESSION['alogin']."'");
...
<input type="text" class="span8 tip" name="nmadmin" style="width:95%;" value="<?php echo $row['nmadmin'];?>">
</div>
</div>
</div>
...
<input type="email" class="span8 tip" name="emailadmin" style="width:95%;" value="<?php echo $row['emailadmin'];?>">
</div>
</div>
</div>
...
<input  type="tel" class="span8 tip" name="phoneadmin" maxlength="13" style="width:95%;" value="<?php echo $row['phoneadmin'];?>">
</div>
</div>
</div>

...
--
-- Host: 127.0.0.1
-- Generation Time: 24 Sep 2019 pada 16.27
...
INSERT INTO `catatandosen` (`id`, `nocatatan`, `status`, `catatan`, `catatan2`, `tanggalcatatan`) VALUES
...
CREATE TABLE `dosen` (
  ...
  `username` varchar(250) NOT NULL,
  `password` varchar(250) NOT NULL,
  `iddosenmk1` int(11) DEFAULT NULL,
  `iddosenmk2` int(11) DEFAULT NULL,
  `iddosenmk3` int(11) DEFAULT NULL,
...
INSERT INTO `dosen` (`id`, `username`, `password`, `iddosenmk1`, `iddosenmk2`, `iddosenmk3`, `dosen`, `creationDate`, `updationDate`) VALUES
...
INSERT INTO `kelompok` (`id`, `klppeterpan`, `nim`, `dosen`, `kehadiran1`, `kehadiran2`, `kehadiran3`, `kehadiran4`, `kehadiran5`, `kehadiran6`, `kehadiran7`, `kehadiran8`, `kehadiran9`, `kehadiran10`, `catatankonsultasi`, `creationDate`, `updationDate`) VALUES
...
INSERT INTO `tblkonsultasi` (`nokonsultasi`, `userId`, `matakuliah`, `namakategori`, `dosen`, `dosen2`, `noc`, `detailkonsultasi`, `detailkonsultasi2`, `filekonsultasi`, `regDate`, `status`, `lastUpdationDate`) VALUES
...
INSERT INTO `users` (`id`, `email`, `fullName`, `nim`, `password`, `contactNo`, `judulskripsi`, `judulkp`, `tempatkp`, `ipk`, `tahunmasuk`, `klppeterpan`, `address`, `nmwarga`, `country`, `pincode`, `userImage`, `regDate`, `updationDate`, `status`) VALUES
...
INSERT INTO `warga` (`id`, `nmwarga`, `deskripsi`, `postingDate`, `updationDate`) VALUES
...
--
ALTER TABLE `tblkonsultasi`
  MODIFY `nokonsultasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

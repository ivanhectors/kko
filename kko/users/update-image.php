...
$query=mysqli_query($con,"update users set userImage='$imgnewfile' where nim='".$_SESSION['login']."'");
if($query)
{
...
<html lang="en">
  <head>
    ...
    <title>Kartu Konsultasi Online | Ubah Foto</title>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Upload Photo Baru</label>
<div class="col-sm-4">
...
<?php } ?>
                          ...
                          <div class="form-group">
                           <div class="col-sm-20" style="padding-left:18% ">
<button type="submit" name="submit" class="btn btn-primary">Submit</button> <button onclick="location.href='profile'" class="btn btn-danger">Cancel</button>
</div>
</div>

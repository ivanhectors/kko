	...
	<div class="module">
							...
							<div class="module-body table">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" >
									<thead>
										<tr>
											<th style="width:5%" title="No. Konsultasi"><center>No</th>
											<th><center>Nama Mahasiswa</th>
											<th><center>Matakuliah</th>
											<th ><center>Reg Date</th>
											<th style="width:5%"><center>Status</th>
...
<tbody>
<?php 
$query=mysqli_query($con,"select tblkonsultasi.*,users.namalengkap as name,matakuliah.kdmatakuliah,matakuliah.matakuliah as makul from tblkonsultasi join matakuliah on tblkonsultasi.idmatakuliah=matakuliah.kdmatakuliah join users on users.nim=tblkonsultasi.idusers where tblkonsultasi.sts_konsul is null and iddosen='".$_SESSION['dlogin']."' ORDER BY tblkonsultasi.regDate DESC");
